!(function (t, e) {
  ...
  function b(t, n) {
    return t != t
      ? n == n
      : t !== n || (t && "object" === e(t)) || "function" == typeof t;
  }
  ...
  function M(t, e) {
    -1 === t.$$.dirty[0] && (_.push(t), k || ((k = !0), j.then(E)), t.$$.dirty.fill(0)),
  ...
  var N = (function (t) {
    ...
    function r(t) {
      ...
      return (n(this, r), (function (t, e, n, r, o, f) {
        var i = arguments.length > 6 && void 0 !== arguments[6]
            ? arguments[6]
            : [-1],
          u = v;
        $(t);
        ...
        if (((
          c.ctx = n
          ? n(t, a, function (e, n) {
            var r = !(arguments.length <= 2) && arguments.length - 2
              ? arguments.length <= 2
                ? void 0
                : arguments[2]
              : n;
          ...
          if (e.hydrate) {
            var p = g(e.target);
            c.fragment && c.fragment.l(p),
            p.forEach(m);
          } else 
            c.fragment && c.fragment.c();
          e.intro && C(t.$$.fragment),
          I(t, e.target, e.anchor),
          E();
        }
        $(u);
    ...
    return ((e = t), (o = [
      {
        ...
        value: function () {
          var t,
            e;
          (t = 1),
          null !== (e = this.$$).fragment && (d(e.on_destroy), e.fragment && e.fragment.d(t), (e.on_destroy = e.fragment = null), (e.ctx = [])),
          (this.$destroy = s);
        }
      }, {
        key: "$on",
